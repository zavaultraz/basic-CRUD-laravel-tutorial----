                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-4">
                        ...
                        <ul class="footer-links footer-blog-entry list-unstyled">
                            ...
                            <li>
                                <a href="{{route('detailNews',$news->slug)}}" class="d-flex align-items-center">
                                    <img src="{{$news->image}}" alt="" class="img-fluid me-3">
                                    <div>
                                        <div class="post-meta d-block"><span class="date">{{$row->name}}</span> <span
                                                class="mx-1">&bullet;</span> <span>{{$news->created_at->format('d F Y')}}</span></div>
                                        <span>{{Str::limit($news->title, 45)}}</span>
                                    </div>
                                </a>
                            </li>
                            @endforeach
